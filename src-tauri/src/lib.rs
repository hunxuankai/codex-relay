...
use crate::tauri_autostart_backend::TauriAutostartBackend;
use crate::tray::TauriFileWatchSink;
use codex_relay_core::initialize_tls_provider;
use std::sync::Arc;
use tauri::Manager;

pub mod app_state;
pub mod commands;
pub use codex_relay_core::{error, models};
pub mod infrastructure;
pub mod services;
pub mod tauri_autostart_backend;
pub mod tray;

#[cfg_attr(mobile, tauri::mobile_entry_point)]
pub fn run() {
    initialize_tls_provider().expect("failed to install the rustls ring crypto provider");
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::provider_commands::save_provider_base_urls,
            commands::provider_commands::select_provider_base_url,
            ...
            commands::provider_commands::apply_provider_connection,
            commands::provider_commands::restore_provider_connection,
            commands::provider_commands::switch_provider,
            commands::provider_commands::import_current_auth_key,
            commands::provider_availability_commands::test_provider_api,
            commands::provider_availability_commands::test_provider_codex_compatibility,
            commands::provider_availability_commands::cancel_provider_test,
            ...
            commands::backup_commands::open_backup_file,
